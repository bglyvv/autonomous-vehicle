...
export default class Simulator {
  ...
  enableManualMode(start=false) {
    ...
    // this.manualCarController.control(false,false,false,false, true);
    // this.carVelocity = 0;
    // this.car.velocity = 0;
    if(start ==true){
      const control = { steer: 0, brake: 1, gas: 0};
      const dt = FRAME_TIMESTEP;
      this.car.update(control,dt)
      this.car.velocity = 0;
    }
